...
%To get arguments under proper symbols
\usepackage{amsmath}
%Mathbb
\usepackage{amsfonts}
...
\section{System R}
\section{Reinforcement learning $\&$ Deep learning}
...
\end{center}
This method does not reduce the search space, and unlikely greedy solution, this will lead to an optimal solution.
This method does not reduce the search space, and unlikely greedy solution, this will lead to an optimal solution.\\
...
\end{document}We are still not certain about how the cost function $J$ is structured.
