...
While the above mentioned categories for optimization are not independent of each other, this thesis focuses solely on operator reordering using deep reinforcement learning.  
